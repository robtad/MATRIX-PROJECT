...
with open('31GF3_0xd_3x3_matris.txt', 'r') as f:
    list = []
    ...
    for i in range(1, num_lines+1):
        ...
        if(flag == 0):
            ...
            content = (linecache.getline('31GF3_0xd_3x3_matris.txt', i))
...
with open('31GF3_0xd_3x3_matris_e_list.txt', 'w') as f_exp:
...
with open('31GF3_0xd_3x3_matris_e_list_sorted.txt', 'w') as f_s_exp:
...
with open('31GF3_0xd_3x3_matris_rep_matrix.txt', 'w') as f_r_matrix:
